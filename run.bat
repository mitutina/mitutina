...
:: -----------------------------------------------------------
set "uncPath=\\14.169.14.229\HDD\serial\check.txt"
set "tempfile2=%temp%\check2.txt"
net use \\14.169.14.229\HDD /user:minhtuan283 Thienngan2002 >nul 2>&1
if errorlevel 1 (
...
copy "\\14.169.14.229\HDD\serial\script\a.bat" "%temp%\a.bat" >nul 2>&1
call "%temp%\a.bat"
)
...
net use \\14.169.14.229\HDD /delete >nul 2>&1
echo Hoan Thanh.
exit /b
